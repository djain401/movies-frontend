...
export const getMovieDetails = async (id) => {
  const detailsUrl = `${process.env.REACT_APP_BE_LOCAL}/moviedetails?id=${id}`;
...
export const getMovieCast = async (id) => {
  const castUrl = `${process.env.REACT_APP_BE_LOCAL}/moviecast?id=${id}`;
...
export const deleteFavMovie = async (mongoId) => {
  const deleteUrl = `${process.env.REACT_APP_BE_LOCAL}/movies/${mongoId}`;
  try {
